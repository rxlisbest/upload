      ...
      <div class="dashboard-container">
        <div class="top-nav">
          <ul>
            ...
            <li>
              <a href="icomoons.html" class="selected">
                <div class="fs1" aria-hidden="true" data-icon="&#xe0a9;"></div>
                Icons
              </a>
            </li>
        ...
        <div class="sub-nav">
          <ul>
            <li><a href="" class="heading">Icons</a></li>
            <li>
              <a href="#buttons">
                Buttons
              </a>
            ...
            <div class="row-fluid">
              ...
              <div class="span12">
                <div class="widget">
                  ...
                  <div class="widget-body">
                    <button class="btn bottom-margin" type="button">
                      Default
                    </button>
                    <button class="btn btn-success bottom-margin" type="button">
                      Success
                    </button>
                    <button class="btn btn-warning2 bottom-margin" type="button">
                      First Warning
                    </button>
                    <button class="btn btn-warning bottom-margin" type="button">
                      Warning
                    </button>
                    <button class="btn btn-danger bottom-margin" type="button">
                      Danger
                    </button>
            ...
            <div class="row-fluid">
              ...
              <div class="span12">
                <div class="widget no-margin">
                  <div class="widget-header">
                    <div class="title">
                      Labels and badge<a id="labels">s</a>
                    </div>
                    <span class="tools">
                      <a class="fs1" aria-hidden="true" data-icon="&#xe090;"></a>
                    </span>
            ...
            <div class="wrapper">
              ...
              <div class="btn-group" data-toggle="buttons-radio">
                <button type="button" class="btn btn-info">
                  <i class=" icon-white icon-bookmark">
                  </i>
                  bookmark
                </button>
                <button type="button" class="btn btn-info">
                  <i class=" icon-white icon-leaf">
                  </i>
                  leaf
                </button>
                <button type="button" class="btn btn-info">
                  <i class=" icon-white icon-adjust">
                  </i>
                  adjust
                </button>
              </div>
