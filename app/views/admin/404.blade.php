...
<![endif]-->
  <head>
    ...
    <link href="css/main.css" rel="stylesheet"> <!-- Important. For Theming change primary-color variable in main.css  --> <!-- Important. For Theming change primary-color variable in main.css  -->
    <!--[if lte IE 7]>
      ...
      <div class="dashboard-container">
        ...
        <div class="sub-nav">
          <ul>
            ...
            <li>
              <a href="404.html" class="selected">
                404
              </a>
            </li>
            <li>
              ...
              <div class="span6">
                ...
                <form>
                  <div class="input-append">
                    ...
                    <a href="index.html" class="fs1 icomoon-home-2 " aria-hidden="true" data-icomoon="" style="display: inline-block; margin: 8px;">
                    </a>
                  </div>
                </form>
              </div>
              ...
              <div class="btn-toolbar no-margin">
                ...
                <div class="btn-group">
                  ...
                  <a href="#" class="btn btn-warning2">
                    <i class="icon-white icon-retweet">
                    </i>
                  </a>
                </div>
              </div>
