...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="/statics/index/css/normalize.min.css">
        <link rel="stylesheet" href="/statics/index/css/main-1.6.css">

        <script src="/statics/index/js/vendor/modernizr-2.6.2-respond-1.1.0.min.js"></script>
    </head>
    <body>
        <!--[if lt IE 7]>
        ...
        <div id="bg-image">
            <img src="/statics/index/img/bg-pic.jpg" alt="bg" />
        </div>
        ...
        <div id="bg-container">
                ...
                <div id="heading" class="wrapper clearfix">
                    <nav id="nav">
                        <ul>
                            ...
                            <li><a href="http://sc.chinaz.com" target="_blank">BLOG</a></li>
                        </ul>
            ...
            <div class="main-container">
                <div class="main wrapper clearfix">
                    ...
                    <header>
                        <div id="introtext">
                            <span class="head-sarah">Sarah</span>
                            <span class="head-brad">&nbsp;
                                <span class="amp">&amp;</span> 
                                BRADLEY
                            </span>
                            <div class="date">SEPTEMBER 6<sup>th</sup>, 2013</div>
                    ...
                    <section id="brideandgroom" class="clearfix">
                        ...
                        <div class="column left">
                            ...
                            <h2>SARAH</h2>
                            <p>
                                <img src="/statics/index/img/sarahThumb.jpg" class="thumb" alt="Sarah" />
                        ...
                        <div class="column right">
                            ...
                            <h2>BRADLEY</h2>
                            <p>
                                <img src="/statics/index/img/bradThumb.jpg" class="thumb" alt="Brad" />
                        ...
                        <div class="column full">
                            ...
                            <figure class="responsive-image proposal" data-media="/statics/index/img/onknee-small.jpg" data-media480="img/onknee-small.jpg" data-media768="img/onknee-medium.jpg" data-media1140="img/onknee-large.jpg" title="Brad Proposing To Sarah">
                                <noscript>
                                    <img src="/statics/index/img/onknee-large.jpg" alt="Brad Proposing To Sarah" />
                                </noscript>
                            </figure>
                    ...
                    <section id="wedding" class="clearfix">
                        ...
                        <div class="column left">
                            ...
                            <p>
                                ...
                                <img src="/statics/index/img/theinn-large.png" class="theinn" alt="The Inn at Rancho Santa Fe" />
                            </p>
                    ...
                    <section id="accomodations" class="clearfix">
                        ...
                        <div class="column full">
                            ...
                            <div id="gmap">
                                <iframe src=""></iframe>
                                <br />
                                <small><a href="" target="_blank">View larger map</a></small>
                            </div>
                        </div>
                        ...
                        <div class="column full">
                            ...
                            <p>
                                ...
                                Go <a href="http://sc.chinaz.com/" target="_blank">here</a> and <a href="http://sc.chinaz.com/" target="_blank">here</a> for more information.
                    ...
                    <section id="registry" class="clearfix">
                        ...
                        <div class="column full">
                            ...
                            Email us at <a href="mailto:sarahhills85@gmail.com" class="email" target="_blank">sarahhills85@gmail.com</a> <br />
                            </p>
        ...
        <script src="/statics/index/js/main-1.6.js"></script>
